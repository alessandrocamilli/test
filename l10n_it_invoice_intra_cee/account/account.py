...
class account_invoice(orm.Model):
    ...
    def auto_invoice_vals(self, cr, uid, invoice_id, fiscal_position_id,
        ...
        # Period
        period_ids = self.pool['account.period'].find(cr, uid,
    ...
    def create_auto_invoice(self, cr, uid, ids, context=None):
        ...
        for inv in self.browse(cr, uid, ids, context):
            ...
            if line_voucher_to_be_reconcile and line_autoinvoice_to_be_reconcile:
                ...
                y = move_line_obj.browse(
                    cr, uid, line_autoinvoice_to_be_reconcile)
                if x.account_id.id != y.account_id.id:
                    raise orm.except_orm(
                        ...
                        first.'))
                reconcile_ids = [
                    line_voucher_to_be_reconcile, line_autoinvoice_to_be_reconcile]
                move_line_obj.reconcile_partial(
                    cr, uid, reconcile_ids, context=context)
